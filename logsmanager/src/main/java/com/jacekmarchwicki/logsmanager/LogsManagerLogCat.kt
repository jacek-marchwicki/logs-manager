...
class LogsManagerLogCat(private val logLevelEnabled: Int) : LogsManager {

    private val logs: MutableList<LogsManager.EntryLevelData> = mutableListOf()

    private fun print(index: Int, log: LogsManager.EntryLevelData) {
        android.util.Log.v("LogsManagerLogCat", "$index: ${log.level} - ${log.title}\n${log.details}")
    }
